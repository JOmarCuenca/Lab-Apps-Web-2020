...
var getAllEventos = function () { return __awaiter(void 0, void 0, void 0, function () {
    var collection, eventos;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, firestore.collection("Eventos").get()];
            case 1:
                collection = _a.sent();
                eventos = collection.docs.map(function (doc) { return toEvento(doc); });
...
function main() {
    ...
    var place2 = { latitude: 5, longitude: 6 };
    var evento = {
        nombre: 'a',
        descripcion: 'b',
        fecha: new Date(),
